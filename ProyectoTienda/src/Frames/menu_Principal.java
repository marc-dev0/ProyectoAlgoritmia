...
public class menu_Principal extends JFrame implements ActionListener {
	...
	public menu_Principal() {
		...
		mnu_BarArchivo.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/archivo.png")));
		mnu_BarArchivo.setBackground(new Color(248, 248, 255));
		mnu_BarArchivo.setForeground(new Color(0, 0, 0));
		menuBar.add(mnu_BarArchivo);
		
		mnu_itemSalir = new JMenuItem("Salir",
						new ImageIcon(menu_Principal.class.getResource("/imagenes/door9.png")));
		...
		mnu_BarMantenimiento.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/screwdriver3.png")));
		...
		mnu_itemConsultarChoco.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/search10.png")));
		...
		mnu_itemListarChoco.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/list40.png")));
		mnu_BarMantenimiento.add(mnu_itemListarChoco);
		
		JMenu mnu_BarVentas = new JMenu("Ventas");
		mnu_BarVentas.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/towels1.png")));
		...
		mnu_itemVenderChoco.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/shopping100.png")));
		...
		mnu_itemGenerarReporte.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/increasing5.png")));
		mnu_BarVentas.add(mnu_itemGenerarReporte);
		
		JMenu mnu_BarConfiguracion = new JMenu("Configuraci\u00F3n");
		mnu_BarConfiguracion.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/settings38.png")));
		...
		mnu_itemDescuentos.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/reduction.png")));
		...
		mnu_itemPrecios.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/dollar1.png")));
		...
		mnu_itemObsequio.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/gift41.png")));
		...
		mnu_itemCantidadOptima = new JMenuItem("Configurar cantidad \u00F3ptima de ventas");
		mnu_itemCantidadOptima.addActionListener(this);
		mnu_itemCantidadOptima.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/stack18.png")));
		mnu_BarConfiguracion.add(mnu_itemCantidadOptima);
		
		JMenu mnu_BarAyuda = new JMenu("Ayuda");
		mnu_BarAyuda.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/help.png")));
		...
		mnu_itemAcerca.setIcon(new ImageIcon(menu_Principal.class.getResource("/imagenes/chocolate.png")));
